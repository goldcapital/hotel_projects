...
public class RegionController {
    ...
    @Operation(summary = "Api for Region get By ID And Visible =true", description = "Get region by admin Id ")
    ...
    public ResponseEntity<RegionDto> update(@Valid  @RequestBody RegionDto dto,
                                            ...
                                            @RequestHeader(value = "Accept-Language",
                                                    defaultValue = "uz") AppLanguage appLanguage) {
        return ResponseEntity.ok(regionService.update(regionId, dto, appLanguage));
    }
